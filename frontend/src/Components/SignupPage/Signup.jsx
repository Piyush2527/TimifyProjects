    ...
    #f2f6f8">
        <Box className={styles.outerSignup} bg='whiteAlpha.400' w='75%' h="800px" color='white'>
            <Box className={styles.signupNav} bg='white' w='100%' h="80px" p={5} color='white'>
                <RouterLink to={"/"}>
                    <Image src="https://res.cloudinary.com/crunchbase-production/image/upload/c_lpad,f_auto,q_auto:eco,dpr_1/zrjqqztub6r2uhvhzwbm" h={35}/>
                </RouterLink>    
                <RouterLink className={styles.links} fontWeight="light" bg='white' textDecoration="none" to={"/login"}>Log In</RouterLink>
            </Box>
            <Box>
                <Box mt="40px">
                    <Heading color="black" fontSize="4xl" fontWeight="400" textAlign="center" mb="20px" >Get started with Timify</Heading>
                ...
                <Box>
                    <Box mt="20px">
                        <Box display="flex" mt="15px" m="auto" w="150px" border="1px solid">
                            <Image m="auto" w="20px" h="20px" src='https://res.cloudinary.com/crunchbase-production/image/upload/c_lpad,f_auto,q_auto:eco,dpr_1/zrjqqztub6r2uhvhzwbm'/>
